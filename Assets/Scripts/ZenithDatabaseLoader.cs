...
public class ZenithDatabaseLoader : MonoBehaviour {
    ...
    public void LoadDatabase() {
        ...
        AddWeapon(ws, "Chain Lightning","Arcing electricity that chains between nearby enemies.",           Rarity.Rare,   20f, 2.0f,  1, WeaponTrait.Explosive,new List<string>{"Electric","Magic"},   fireMode: FireMode.RandomInRange, range: 25f, spriteFolder: "ChainLightning");
