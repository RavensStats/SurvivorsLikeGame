...
public class ZenithDatabaseLoader : MonoBehaviour {
    ...
    public void LoadDatabase() {
        ...
        AddWeapon(ws, "Sentry Gun",     "Deploys a rapid-burst turret targeting nearby enemies.",          Rarity.Rare,   8f,  0.3f,  1, WeaponTrait.None,     new List<string>{"Physical","Ranged"},   fireMode: FireMode.AnimatedStrike, range: 20f, spriteFolder: "SentryGun");
