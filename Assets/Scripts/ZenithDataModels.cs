...
public enum FireMode { Default, NearestN, RandomInRange, ArcSwing, Orbit, RisingFist, ScytheOrbit, ChainLightning, VoidOrb, HolySword, AnimatedStrike, OracleBeam, SpectralBeam, TidalWave }
